...
// Cabin starts burning as of level 12. Part of game plot.
if (levels.twelve){
	$('#cabin').attr('src','../pics/butterflies/burning-cabin.png');
	$('#cabin').css({"pointer-events": "none", "top": "62%", "width": "14.5%", "left": "33%"})
	$('.main').append($('<img>').attr('src', '../pics/butterflies/smoke.gif').attr('id', 'smoke'));
}
