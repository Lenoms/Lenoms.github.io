...
function get_response(form_number){
	if (form_number == 'one'){
		...
		return ['donna', 'Donna', 'Remember: blue, then red, but NEVER green'];
	}
		...
		return ['amber', 'Amber', "The answer to this level is 'harbour'. But before you go, the others might have some valuable information..."];
	}
