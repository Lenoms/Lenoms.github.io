...
// Change to ripped scrolls for game plot
if (levels.eleven){
	$('.xxxxxxxxxx').attr('src','../pics/silvanus/xxxxx2.png');
}

// Below code just replaces all xs input by the player to the next character of the answer string.
